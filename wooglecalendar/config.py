""":mod:`wooglecalendar.config` --- Reading configurations
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

This file is derived from cliche/config.py file from Cliche_ project.
...
def read_config(filename):
    """Read WoogleCalendar app configuration from the given filename.  ::
...
def read_config_from_yaml(*, string=None, file=None, filename=None):
    """Read WoogleCalendar app configuration from YAML.  ::
...
def read_config_from_python(*, string=None, file=None, filename=None):
    """Read WoogleCalendar app configuration from Python code i.e. Flask-style
    configuration::
