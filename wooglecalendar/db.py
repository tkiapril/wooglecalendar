""":mod:`wooglecalendar.db` --- Database connections
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Use :data:`session` in view functions.
This file is derived from cliche/web/db.py file from Cliche_ project.
...
def get_session():
    ...
    :returns: a session
    :rtype: :class:`~wooglecalendar.orm.Session`
...
#: (:class:`~werkzeug.local.LocalProxy` of :class:`~wooglecalendar.orm.Session`)
